                      ...
                      <div className="nk-footer-brand pb-5 pb-lg-0">
                        <div className="nk-footer-brand-info mb-4">
                          <div className="nk-footer-logo">
                            <NioBrand size="150px" logo={data.footer.logo?.name} variant={data.footer.logo?.variant} />
                          </div>
                        ...
                        <Col sm={8} md={7}>
                          <div className="nk-footer-info">
                            ...
                            <ul className="row gy-1 gy-sm-4">
                              <li className="col-6">
                                <Link to="/about-solution">About Us</Link>
                              </li>
                              <li className="col-6">
                              ...
                              <li className="col-6">
                                <Link to="/index-bs-subscription">Pricing</Link>
                              </li>
                              <li className="col-6">
                        ...
                        <Col sm={4}>
                          <div className="nk-footer-info">
                            ...
                            <ul className="row gy-1 gy-sm-4">
                              ...
                              <li className="col-12">
                                <Link to="/auth/sign-upB">Sign up Company </Link>
                              </li>
                              <li className="col-12">
                                <Link to="/auth/sign-upData">Sign up Challenged </Link>
                              </li>
                              <li className="col-12">
